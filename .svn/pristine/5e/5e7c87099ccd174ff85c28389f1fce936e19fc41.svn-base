...
namespace Root.Reports {
  ...
  internal class Type1FontData : FontData {
    ...
    internal Type1FontData(String sFontName, FontDef.Style style) : base(style, FontData.Encoding.Cp1252) {
      switch (style) {
        case FontDef.Style.Bold: {
    ...
    internal Double rSizeFactor(FontProp fontProp) {
      ...
      return fontProp.rSize * 1000.0 / fCapHeight;
    }
    ...
    internal  protected override Double rHeight(FontProp fontProp) {
      ...
      return rSizeFactor(fontProp) * f / 1000F;
    }
    ...
    internal  protected override Double rWidth(FontProp fontProp, String sText) {
      return rSizeFactor(fontProp) * rRawWidth(sText) / 1000;
    }
    #endregion
