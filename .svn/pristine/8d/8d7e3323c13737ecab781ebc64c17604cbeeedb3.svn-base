...
namespace Root.Reports {
  ...
  public sealed class FontDef {
    ...
    /// <param name="report">Report to which this font belongs</param>
    /// <param name="sFontName">Name of the font family</param>
    /// <param name="fontFamily">Font family object</param>
...
#else
      if ("courier,helvetica,times-roman,symbol,zapfdingbats".IndexOf(sFontName.ToLower()) > -1) {
#endif
    ...
    internal sealed class AFontData {
      ...
      /// <param name="style">Style value that identifies the font data object</param>
      ...
      internal FontData this[Style style] {
        get {
          Int32 i = (Int32)style;
          FontData fontData = aFontData[i];
          if (fontData == null) {
            if (fontDef.fontType == FontType.InternalAFM) {
              fontData = new Type1FontData(fontDef.sFontName, style);
            }
            else {
              fontData = new TrueTypeFontData(fontDef, style);
            }
