...
namespace Root.Reports {
  ...
  public abstract class Container	: RepObj, IEnumerable {
    ...
    internal readonly ArrayList al_RepObj;

    //----------------------------------------------------------------------------------------------------x
    /// <summary>Creates a new container.</summary>
    protected Container() {
      al_RepObj = new ArrayList(20);
    }
    ...
    internal void Add(RepObj repObj, RepObj repObj_Pos) {
      ...
      if (repObj_Pos == null) {
        ...
        Int32 iIndex = al_RepObj.IndexOf(repObj_Pos);
        Debug.Assert(iIndex >= 0);
        al_RepObj.Insert(iIndex, repObj);
      }
    ...
    public IEnumerator GetEnumerator() {
      return al_RepObj.GetEnumerator();
    }
  }
}
